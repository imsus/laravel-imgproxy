...
- Pro options (`maxSrc*`, `preserveHdr`, `enforceThumbnail`, `returnAttachment`, …) are preset-able because their typed methods already exist; consistent with issue 06's deferral — docs-pinned, not live-verified.
