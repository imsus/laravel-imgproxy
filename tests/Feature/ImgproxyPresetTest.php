...
it('composes a configured preset on the default instance', function () {
    expect(Imgproxy::image('http://example.com/image.jpg')->applyPreset('thumb')->url())
...
it('composes the same preset on a named instance with its own encoding and signature size', function () {
    expect(Imgproxy::instance('staging')->image('http://example.com/image.jpg')->applyPreset('thumb')->url())
...
it('builds a placeholder on a named instance', function () {
    expect(Imgproxy::instance('staging')->image('http://example.com/image.jpg')->placeholder()->url())
...
it('throws on an unconfigured preset through the facade', function () {
    Imgproxy::image('http://example.com/image.jpg')->applyPreset('missing');
